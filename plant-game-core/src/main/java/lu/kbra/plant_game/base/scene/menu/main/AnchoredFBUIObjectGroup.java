...
public class AnchoredFBUIObjectGroup extends FixedBoundsUIObjectGroup implements AnchorOwner {

	protected Anchor objectAnchor;
	protected Anchor targetAnchor;

	public AnchoredFBUIObjectGroup(final String str, final Layout layout, final Direction2d dir, final float size, final Anchor objectAnchor,
			final Anchor targetAnchor, final UIObject... values) {
		super(str, layout, dir, size, values);
		this.objectAnchor = objectAnchor;
		this.targetAnchor = targetAnchor;
	}

	public AnchoredFBUIObjectGroup(final String str, final Layout layout, final Transform3D transform, final Direction2d dir,
			final float size, final Anchor objectAnchor, final Anchor targetAnchor, final UIObject... values) {
		super(str, layout, transform, dir, size, values);
		this.objectAnchor = objectAnchor;
		this.targetAnchor = targetAnchor;
	}

	public AnchoredFBUIObjectGroup(final String str, final Layout layout, final UIObjectGroup parent, final Direction2d dir, final float size,
			final Anchor objectAnchor, final Anchor targetAnchor, final UIObject... values) {
	...
	public String toString() {
		return "AnchorFBUIObjectGroup@" + System.identityHashCode(this) + " [objectAnchor=" + this.objectAnchor + ", targetAnchor="
