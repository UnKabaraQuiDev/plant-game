...
//		register(ENERGY, new BuildingDefinition<>(SolarPanelMediumObject.class, 45, List.of(), List.of(), 20));
		this.register(ENERGY, new BuildingDefinition<>(SolarPanelSmallObject.class, 40, List.of(), List.of(), 10));
		this.register(ENERGY, new BuildingDefinition<>(WindTurbineMediumObject.class, 125, List.of(), List.of(), 20));
		this.register(ENERGY, new BuildingDefinition<>(WaterWheelObject.class, 125, List.of(), List.of(), 30));
