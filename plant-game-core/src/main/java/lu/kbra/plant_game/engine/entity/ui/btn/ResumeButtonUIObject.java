...
@DataPath("localization:btn.resume")
public class ResumeButtonUIObject extends MainMenuItemTextUIObject implements NeedsClick, IndexOwner, UISceneParentAware, AnimatedOnHover {

	public ResumeButtonUIObject(final String str, final TextEmitter text) {
		super(str, text);
	}
	...
	public void click(final WindowInputHandler input) {
		this.getUISceneParent()
				...
				.ifPresent(c -> PGLogic.INSTANCE.resumeLevel(c.getResumeInfoGroup().getCurrentLevelDefinition()));
	}
