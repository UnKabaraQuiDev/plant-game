...
@DataPath("localization:btn.return")
public class ReturnButtonUIObject extends MainMenuItemTextUIObject {

	public static final Vector4fc TARGET_RED = new Vector4f(1, 0.25f, 0.25f, 1);

	public ReturnButtonUIObject(final String str, final TextEmitter text) {
		super(str, text);
	...
	public String toString() {
		return "ReturnButtonUIObject@" + System.identityHashCode(this) + " [growthProgress=" + this.growthProgress + ", transform="
