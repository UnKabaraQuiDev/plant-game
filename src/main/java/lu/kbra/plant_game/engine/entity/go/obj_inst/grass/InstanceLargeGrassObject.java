...
public class InstanceLargeGrassObject extends InstanceSwayGameObject {
	...
	public InstanceLargeGrassObject(
			final String str,
	...
	public InstanceLargeGrassObject(final String str, final SwayInstanceEmitter instanceEmitter, final short materialId) {
	...
	public InstanceLargeGrassObject(final String str, final SwayInstanceEmitter instanceEmitter, final Transform3D transform) {
		super(str, instanceEmitter, transform);
		// TODO Auto-generated constructor stub
	}

	public InstanceLargeGrassObject(final String str, final SwayInstanceEmitter instanceEmitter) {
