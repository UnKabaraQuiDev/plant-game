...
@DataPath("classpath:/models/grass_small.json")
public class InstanceSmallGrassObject extends InstanceSwayGameObject {

	public InstanceSmallGrassObject(
			final String str,
	...
	public InstanceSmallGrassObject(final String str, final SwayInstanceEmitter instanceEmitter, final short materialId) {
	...
	public InstanceSmallGrassObject(final String str, final SwayInstanceEmitter instanceEmitter, final Transform3D transform) {
		super(str, instanceEmitter, transform);
		// TODO Auto-generated constructor stub
	}

	public InstanceSmallGrassObject(final String str, final SwayInstanceEmitter instanceEmitter) {
