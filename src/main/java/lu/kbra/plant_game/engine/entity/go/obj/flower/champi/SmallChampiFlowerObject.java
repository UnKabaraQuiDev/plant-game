...
public class SmallChampiFlowerObject extends SwayGameObject {
	...
	public SmallChampiFlowerObject(final String str, final SwayMesh swayMesh, final Transform3D transform) {
		super(str, swayMesh, transform);
		// TODO Auto-generated constructor stub
	}

	public SmallChampiFlowerObject(
			final String str,
	...
	public SmallChampiFlowerObject(final String str, final SwayMesh swayMesh, final Transform3D transform, final short materialId) {
