...
public class MediumChampiFlowerObject extends SwayGameObject {
	...
	public MediumChampiFlowerObject(
			final String str,
	...
	public MediumChampiFlowerObject(final String str, final SwayMesh swayMesh, final Transform3D transform, final short materialId) {
