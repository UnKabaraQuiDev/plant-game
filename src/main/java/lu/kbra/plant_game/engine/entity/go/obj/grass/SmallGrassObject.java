...
public class SmallGrassObject extends SwayGameObject {
	...
	public SmallGrassObject(final String str, final SwayMesh swayMesh, final Transform3D transform) {
		super(str, swayMesh, transform);
		// TODO Auto-generated constructor stub
	}

	public SmallGrassObject(
			final String str,
	...
	public SmallGrassObject(final String str, final SwayMesh swayMesh, final Transform3D transform, final short materialId) {
