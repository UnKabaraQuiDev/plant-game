...
public class SmallRoundFlowerObject extends SwayGameObject {
	...
	public SmallRoundFlowerObject(final String str, final SwayMesh swayMesh, final Transform3D transform) {
		super(str, swayMesh, transform);
		// TODO Auto-generated constructor stub
	}

	public SmallRoundFlowerObject(
			final String str,
	...
	public SmallRoundFlowerObject(final String str, final SwayMesh swayMesh, final Transform3D transform, final short materialId) {
