...
@DataPath("classpath:/models/champi_small.json")
public class InstanceSmallChampiFlowerObject extends InstanceSwayGameObject {

	public InstanceSmallChampiFlowerObject(
			final String str,
	...
	public InstanceSmallChampiFlowerObject(final String str, final SwayInstanceEmitter instanceEmitter, final short materialId) {
	...
	public InstanceSmallChampiFlowerObject(final String str, final SwayInstanceEmitter instanceEmitter, final Transform3D transform) {
		super(str, instanceEmitter, transform);
		// TODO Auto-generated constructor stub
	}

	public InstanceSmallChampiFlowerObject(final String str, final SwayInstanceEmitter instanceEmitter) {
