package lu.kbra.plant_game.engine.entity.go.obj_inst.grass.flower.champi;
...
@DataPath("classpath:/models/champi_large.json")
public class InstanceLargeChampiFlowerObject extends InstanceSwayGameObject {

	public InstanceLargeChampiFlowerObject(
			final String str,
	...
	public InstanceLargeChampiFlowerObject(final String str, final SwayInstanceEmitter instanceEmitter, final short materialId) {
	...
	public InstanceLargeChampiFlowerObject(final String str, final SwayInstanceEmitter instanceEmitter, final Transform3D transform) {
		super(str, instanceEmitter, transform);
		// TODO Auto-generated constructor stub
	}

	public InstanceLargeChampiFlowerObject(final String str, final SwayInstanceEmitter instanceEmitter) {
