...
public class AnimatedTexturedLoadedMesh extends OffsetMesh implements TexturedMesh, AnimatedMesh {
	...
	public AnimatedTexturedLoadedMesh(String name, Material mat, Vector3f origin, SingleTexture texture,
			AnimationData data, Vec3fAttribArray vertices, UIntAttribArray indices, AttribArray... attribs) {
