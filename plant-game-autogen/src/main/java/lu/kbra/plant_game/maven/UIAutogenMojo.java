...
public class UIAutogenMojo extends AbstractMojo implements AutogenDefaults {
	...
	public void genRegistry(final ClassLoader scanClassLoader, final URL[] urls, final String scanPackage,
		...
		final Class<?> gameObjectClass = scanClassLoader.loadClass("lu.kbra.plant_game.engine.entity.ui.UIObject");
		...
		final Class<?> gameObjectRegistryClass = scanClassLoader
				.loadClass("lu.kbra.plant_game.plugin.registry.UIObjectRegistry");
		...
		final Class<? extends Exception> gameObjectNotFoundClass = (Class<? extends Exception>) scanClassLoader
				.loadClass("lu.kbra.plant_game.engine.util.exceptions.UIObjectNotFound");
		final Class<? extends Exception> gameObjectConstructorNotFoundClass = (Class<? extends Exception>) scanClassLoader
				.loadClass("lu.kbra.plant_game.engine.util.exceptions.UIObjectConstructorNotFound");
		...
		final String uiObjectConstructorsMap = PCUtils.camelCaseToConstant("uiObjectConstructors");
...
//		final String defaultPriceMap = PCUtils.camelCaseToConstant("defaultPrice");
		...
		final TypeSpec.Builder registry = TypeSpec.classBuilder("GenUIRegistry").superclass(gameObjectRegistryClass)
...
//				continue;
			...
			initMethod.addStatement(uiObjectConstructorsMap + ".put($T.class, $L)", c, listName);
